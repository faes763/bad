...
function Game() {
    ...
    // let clickY = event.nativeEvent.offsetY
    // let clickX = event.nativeEvent.offsetX; 
    // let targetWidth = event.target.offsetWidth; 
    // let targetHeight = event.target.offsetHeight; 

    // let rightBottomBorder = clickX > targetWidth / 2 && clickY > targetHeight / 2; 
    // let leftBottomBorder = clickX < targetWidth / 2 && clickY > targetHeight / 2; 
    // let rightTopBorder = clickX > targetWidth / 2 && clickY < targetHeight / 2; 
    // let leftTopBorder = clickX < targetWidth / 2 && clickY < targetHeight / 2; 
    
    // if (rightBottomBorder && event.target.children.length <= 0 && event.target.nodeName == "DIV") {
        
    //     // console.log('Правый нижний угол'); 
    //     // console.log(event)
    // } 
    // if (leftBottomBorder && event.target.children.length <= 0 && event.target.nodeName == "DIV") {
    //     event.target.appendChild(span).classList.add(colors)
    //     // console.log(event)
    //     // console.log('левый нижний угол'); 
    // } 
    // if (rightTopBorder && event.target.children.length <= 0 && event.target.nodeName == "DIV") {
    //     event.target.appendChild(span).classList.add(colors)
    //     // console.log(event)
    //     // console.log('Правый верхний угол'); 
    // } 
    // if (leftTopBorder && event.target.children.length <= 0 && event.target.nodeName == "DIV") {
    //     event.target.appendChild(span).classList.add(colors)
    //     // console.log(event)
